...
class PurchaseOrderController extends Controller
{
    ...
    public function deleteOrder($purchaseOrderId)
    {
        dd($purchaseOrderId);
        $purchaseOrder = PurchaseOrder::findOrFail($purchaseOrder->purchase_order_id);
        $purchaseOrder->delete();

        return redirect()->route('orders.list')->with('success', 'Orden de compra eliminada correctamente');
    }
}
